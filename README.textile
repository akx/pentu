...
|Firefox 3.6.12|All successful (after some gentle coercion: innerText and outerHTML aren't supported by default, but the test suite adds shims)|
|Opera 11.00|All successful (though seems Opera always returns hex color values, despite what you assign)|
|Internet Explorer 8|5 tests work (after some hacks and kludges to the testing harness)|
|Android 2.3 (sdk-eng 2.3 GRH55 79397 test-keys)|All successful|
